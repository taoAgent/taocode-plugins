...
Workflow skills that make the agent build reliably — model-invoked, no setup.

## What's inside

- **`test-driven-development`** — write a failing test first, then the minimal code to pass.
- **`systematic-debugging`** — find the root cause before changing code, on any bug or test failure.
